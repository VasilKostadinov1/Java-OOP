...
public class ControllerImpl implements Controller {
    ...
    public String exploreState(String stateName) {
        ...
        State currentState = this.stateRepository.byName(stateName);
        mission.explore(currentState, suitableExplorers);
        long retiredCount = suitableExplorers.stream().filter(e -> e.getEnergy() == 0).count();
        exploredStatesCount++;
